...
class DioService {
  ...
  Future<Response> post(String url, {Map<String, dynamic>? parameters, Map<String, dynamic>? headers}) async {
  ...
  Future<Response> put(String url, {Map<String, dynamic>? parameters, Map<String, dynamic>? headers}) async {
  ...
  Future<Response> patch(String url, {Map<String, dynamic>? parameters, Map<String, dynamic>? headers}) async {
